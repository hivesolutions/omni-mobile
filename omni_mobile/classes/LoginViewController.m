...
- (void)remoteDidSucceed:(HMRemoteAbstraction *)remoteAbstraction data:(NSData *)data connection:(NSURLConnection *)connection response:(NSURLResponse *)response {
    ...
    // otherwise there must be a problem
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Login Error", @"Login Error") message:message delegate:nil cancelButtonTitle:NSLocalizedString(@"Confirmar", @"Confirmar") otherButtonTitles: nil];
